"""Representative annual acceptance check, derived from analyse.py on scope revision 2026-09-14.
...
for group in [g for g in p['studies'] if g['key']=='annual']:
    ...
    for case in manifest['cases'][:1]:
        ...
        windows=[case['hours']]  # One acceptance boundary; no research-prefix sweep.
        prefixes=[]
        for n in windows:
