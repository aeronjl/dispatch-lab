# Legacy hydrogen prototype · v0.1

This guide describes the preserved hydrogen-only prototype. For the current
methane platform, use the [main README](../README.md). Commands below run from
the repository root; launch this version with `uv run python app.py --legacy`.
